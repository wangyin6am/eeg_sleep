...
def download_file(name, astype=None, filename=None, to_path=None, unzip=False,
    ...
    if to_download:
        ...
        urllib.request.urlretrieve(url, path_to_file, reporthook=reporthook)
        # Unzip file :
        if unzip:
            # # Unzip archive :
            ...
            # wy 下载修改
            with zipfile.ZipFile(path_to_file, 'r') as zip_file_object:
                zip_file_object.extractall(to_path)

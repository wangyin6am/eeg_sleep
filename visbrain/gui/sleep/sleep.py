...
class Sleep(_PyQtModule, ReadSleepData, UiInit, Visuals, UiElements,
    ...
    """
    # wy睡眠第二标签 添加hypno_2=None
    def __init__(self, data=None, hypno=None, hypno_2=None, hypno_2_flag=False, config_file=None,
        ...
        # 真正的读数据
        # wy睡眠第二标签 添加hypno_2,hypno_2_flag
        ReadSleepData.__init__(self, data, channels, sf, hypno, hypno_2, hypno_2_flag, href, preload,
        ...
        # wy 第二睡眠标签
        if self._hypno2Flag:
            self._hypcolor = {-1: '#FF0000', 0: '#FF0000', 1: '#FF0000',
                              2: '#FF0000', 3: '#FF0000', 4: '#FF0000'}
        else:
            self._hypcolor = {-1: '#FFFF00', 0: '#FF0000', 1: '#00FF00',
                              2: '#0000FF', 3: '#00ccff', 4: '#B23AEE'}
        # wy 黄、红、绿、蓝、天蓝、紫，
        # self._hypcolor = {-1: '#FFFF00', 0: '#FF0000', 1: '#00FF00',
        #                   2: '#0000FF', 3: '#00ccff', 4: '#B23AEE'}
        ...
        self._defcmap = 'rainbow'
        # Spindles / REM / Peaks colors :
        # 波形颜色设置
        self._defspin = color2vb('#fe25fa') # 粉红#fe25fa 亮绿色#66ff00 天蓝色#00ccff
        self._defsw = color2vb('#56bf8b') # 暗绿色
        self._defkc = color2vb('#b45a3c') # 暗橙色
        self._defrem = color2vb('#6684e1') # 暗蓝色
        self._defmt = color2vb('#FE8625') # 橙色
        self._defpeaks = '#b854d4' # 紫色
        self._defspina = color2vb('#66ff00')# 亮绿色
        self._defspinb = color2vb('#00ccff')# 天蓝色
    ...
    def replace_detections(self, dtype, method):
        ...
        # Type checking :
        # wy 纺锤波方法
        meth_names = ('spindle', 'sw', 'kc', 'rem', 'mt', 'peak', 'spindle-a', 'spindle-b', 'artifact-EEG', 'artifact-ECG')
